//
//  FolloweeListViewController.swift
...
class FolloweeListViewController: UIViewController, ProgressPresentableView, UserListViewOutput {
    ...
    private func fetchUsers() {
        showProgress()
        UserAPI.fetchFolloweesByUserId(id: userId, page: currentPage, perPage: 20) { [weak self] (users, error) in
